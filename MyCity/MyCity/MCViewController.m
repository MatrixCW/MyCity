...
- (void)viewDidAppear:(BOOL)animated{
    ...
    if (![PFUser currentUser]) { // No user logged in
        ...
        [logInViewController setFields: logInViewController.fields | PFLogInFieldsFacebook | PFLogInFieldsDismissButton];
...
#pragma PFLogInViewController Delegate Methods
...
#pragma PFSignUpViewController Delegate Methods
